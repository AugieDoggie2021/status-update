...
export function KPIs({ workstreams, risks, overall: overallProp }: KPIsProps) {
  ...
  return (
    <div className="grid gap-3 md:grid-cols-4">
      <Card className="bg-gradient-to-br from-slate-100 to-slate-200 border border-slate-300 shadow-sm">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 bg-gradient-to-r from-slate-300 to-slate-400 rounded-t-lg">
          <CardTitle className="text-sm font-medium text-slate-900">Overall Status</CardTitle>
        </CardHeader>
      ...
      <Card className="bg-gradient-to-br from-slate-100 to-slate-200 border border-slate-300 shadow-sm">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 bg-gradient-to-r from-slate-300 to-slate-400 rounded-t-lg">
          <CardTitle className="text-sm font-medium text-slate-900">% On Track</CardTitle>
        </CardHeader>
        <CardContent className="pt-2 pb-4">
          <div className="text-2xl font-bold text-slate-900">{onTrackPercent}%</div>
      ...
      <Card className="bg-gradient-to-br from-slate-100 to-slate-200 border border-slate-300 shadow-sm">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 bg-gradient-to-r from-slate-300 to-slate-400 rounded-t-lg">
          <CardTitle className="text-sm font-medium text-slate-900">Open Risks</CardTitle>
        </CardHeader>
        <CardContent className="pt-2 pb-4">
          <div className="text-2xl font-bold text-slate-900">{openRisksCount}</div>
          <p className="text-xs text-slate-700">Active risks</p>
        </CardContent>
      </Card>
      <Card className="bg-gradient-to-br from-slate-100 to-slate-200 border border-slate-300 shadow-sm">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 bg-gradient-to-r from-slate-300 to-slate-400 rounded-t-lg">
          <CardTitle className="text-sm font-medium text-slate-900">Next 7 Days</CardTitle>
        </CardHeader>
        <CardContent className="pt-2 pb-4">
          <div className="text-2xl font-bold text-slate-900">{next7DayMilestones}</div>
          <p className="text-xs text-slate-700">Upcoming milestones</p>
        </CardContent>
      </Card>
    </div>
  );
